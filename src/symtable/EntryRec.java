...
public class EntryRec extends EntryTable {
    ...
    public int dim; // dimenso
    public EntryRec next; // apontador para o resto da lista
    public int cont; // nmero de elementos a partir daquele elemento
    ...
    // cria elemento e pe no incio da lista
    ...
    // devolve a representao da EntryRec na forma de string
    public String toStr() {
        String s;
