...
public class PrintTree {
    ...
    public void printNotNode(NotNode x) {
        ...
        System.out.println();
        System.out.print(x.number + ": NotNode ===> " + x.expr1.number + " " +
            x.position.image + " " + x.expr2.number);
        printExpreNode(x.expr1);
        printExpreNode(x.expr2);
    }
    ...
    // -------------------------- Constante inteira ----------------------
    public void numberIntNode(IntNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printIntNode(IntNode x) {
        if (x == null) {
            return;
        }
    ...
    // ------------------------ Constante string ----------------------------
    public void numberStringNode(StringNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printStringNode(StringNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": StringNode ===> " +
            x.position.image);
    }

    // ------------------------------ Constante null --------------------------
    public void numberNullNode(NullNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printNullNode(NullNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": NullNode ===> " + x.position.image);
    }

    
    // -------------------------- VBoolean ----------------------
    public void numberBooleanNode(BooleanNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printBooleanNode(BooleanNode x) {
        if (x == null) {
            return;
        }
       
        System.out.println();
        System.out.print(x.number + ": BooleanNode ===> " + x.position.image);
    }
    
 // -------------------------- VChar ----------------------
    public void numberCharNode(CharNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printCharNode(CharNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": CharNode ===> " + x.position.image);
    }
    
 // -------------------------- VFloat ----------------------
    public void numberFloatNode(FloatNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printFloatNode(FloatNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": FloatNode ===> " + x.position.image);
    }
    ...
    public void printExpreNode(ExpreNode x) {
        if (x instanceof NewObjectNode) {
            ...
            printIntNode((IntNode) x);
        } else if (x instanceof StringNode) {
            printStringNode((StringNode) x);
        } else if (x instanceof NullNode) {
            printNullNode((NullNode) x);
    ...
    public void numberExpreNode(ExpreNode x) {
        if (x instanceof NewObjectNode) {
            ...
            numberIntNode((IntNode) x);
        } else if (x instanceof StringNode) {
            numberStringNode((StringNode) x);
        } else if (x instanceof BooleanNode) {
